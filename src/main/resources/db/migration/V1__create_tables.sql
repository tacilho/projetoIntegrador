...
CREATE TABLE IF NOT EXISTS entradas (
    ...
    brinquedo_id BIGINT,
    data DATE,
    CONSTRAINT fk_entrada_jogo FOREIGN KEY (jogo_id) REFERENCES jogos(id),
    CONSTRAINT fk_entrada_brinquedo FOREIGN KEY (brinquedo_id) REFERENCES brinquedos(id)
);
...
CREATE TABLE IF NOT EXISTS saidas (
    ...
    brinquedo_id BIGINT,
    data DATE,
    CONSTRAINT fk_saida_jogo FOREIGN KEY (jogo_id) REFERENCES jogos(id),
    CONSTRAINT fk_saida_brinquedo FOREIGN KEY (brinquedo_id) REFERENCES brinquedos(id)
);
